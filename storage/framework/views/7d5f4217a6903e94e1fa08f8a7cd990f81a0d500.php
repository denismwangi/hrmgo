<?php
    ...
    // @dd($enable_cookie['enable_cookie']);
    // @dd(env('APP_URL'));
    // @dd($meta_logo);
?>
...
<body class="<?php echo e($color); ?>">
    ...
    <footer class="dash-footer">
        <div class="footer-wrapper">
            <div class="py-1">
                <span class="text-muted">&copy;<?php echo e(__('Copyright')); ?>
...
<?php /**PATH E:\xampp\htdocs\codecanyon-osVkYVLM-hrmgo-saas-hrm-and-payroll-tool (1)\main_file\resources\views/layouts/admin.blade.php ENDPATH**/ ?>