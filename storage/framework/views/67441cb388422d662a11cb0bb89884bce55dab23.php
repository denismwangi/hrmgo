                    ...
                    <div class="card-body " style="height: 295px">
                        ...
                        <ul class="list-unstyled my-4">
                            <li>
                                ...
                                <?php echo e($plan->max_users == -1 ? __('Lifetime') : $plan->max_users); ?> <?php echo e(__('Users')); ?>

                            </li>
                            <li>
                                <span class="theme-avtar">
                                    <i class="text-primary ti ti-circle-plus"></i></span>
                                <?php echo e($plan->max_employees == -1 ? __('Lifetime') : $plan->max_employees); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\codecanyon-osVkYVLM-hrmgo-saas-hrm-and-payroll-tool (1)\main_file\resources\views/plan/index.blade.php ENDPATH**/ ?>