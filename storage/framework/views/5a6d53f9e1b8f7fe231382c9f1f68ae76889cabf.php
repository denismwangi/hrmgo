...
<head>
    ...
    <meta property="og:image"
        content="<?php echo e(isset($meta_logo) && !empty(asset('storage/meta/' . $meta_logo)) ? asset('storage/meta/' . $meta_logo) : 'hrmgo.png'); ?>">
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e($logos . '/favicon.png'); ?>" type="image/x-icon" />
...
<body class="<?php echo e($color); ?>">
    ...
    <nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                <img src="<?php echo e($logos . '/' . '2_light_logo.png'); ?>" alt="<?php echo e(config('app.name', 'HRMGO')); ?>"
                    alt="logo">
            </a>
    ...
    <section id="dashboard" class="theme-alt-bg dashboard-block">
        <div class="container">
            ...
            <img src="<?php echo e(asset('landing/hrmgo-saas-pic-1.png')); ?>" alt=""
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="<?php echo e(asset('landing/hrmgo-saas-pic-1.png')); ?>" alt="Datta Able Admin Template"
                        class="img-fluid header-img wow animate__fadeInRight" data-wow-delay="0.2s" />
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-12 text-end">
                    ...
                    <p class="text-body">&copy;<?php echo e(__('Copyright')); ?>
...
<?php /**PATH E:\xampp\htdocs\codecanyon-osVkYVLM-hrmgo-saas-hrm-and-payroll-tool (1)\main_file\resources\views/layouts/landing.blade.php ENDPATH**/ ?>