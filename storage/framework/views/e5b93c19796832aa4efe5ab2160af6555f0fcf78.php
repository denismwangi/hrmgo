            ...
            <ul class="dash-navbar">
                ...
                <?php else: ?>
                    <?php if(Gate::check('Manage User') ||
                        ...
                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'user' || Request::segment(1) == 'roles' 
                        || Request::segment(1) == 'lastlogin')?' active dash-trigger':''); ?> ">
                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                        class="ti ti-users"></i></span><span
                                    class="dash-mtext"><?php echo e(__('Staff')); ?></span><span class="dash-arrow"><i
                                        data-feather="chevron-right"></i></span></a>
                            <ul class="dash-submenu <?php echo e((Request::route()->getName() == 'user.index' || Request::route()->getName() == 'users.create' || Request::route()->getName() == 'user.edit' || Request::route()->getName() == 'lastlogin') ? ' active' : ''); ?> ">
...
<?php endif; ?> -->
                ...
                <?php if(Gate::check('Manage Department') ||
                    ...
                    <li class="dash-item dash-hasmenu">
                        <a href="<?php echo e(route('branch.index')); ?>" class="dash-link"><span
                                class="dash-micon"><i class="ti ti-table"></i></span><span
...
<?php /**PATH E:\xampp\htdocs\codecanyon-osVkYVLM-hrmgo-saas-hrm-and-payroll-tool (1)\main_file\resources\views/partial/Admin/menu.blade.php ENDPATH**/ ?>