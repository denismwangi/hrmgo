                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control editor " name="description" id="description" rows="3">{{$job->description}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control editor " name="requirement" id="requirement" rows="3">{{$job->requirement}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
