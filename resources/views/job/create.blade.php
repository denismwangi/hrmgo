                ...
                <div class="card-body ">
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            {!! Form::date('start_date', old('start_date'), ['class' => 'form-control current_date', 'autocomplete' => 'off']) !!}
                        </div>
                        <div class="form-group col-md-6">
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control editor " name="description" id="description" rows="3"></textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body ">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea class="form-control editor " name="requirement" id="requirement" rows="3"></textarea>
                        </div>
                    </div>
                </div>
            </div>
