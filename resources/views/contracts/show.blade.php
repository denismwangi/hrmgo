    ...
    <div class="col-md-6 text-end d-flex ">
        ...
        @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'employee')
            <a href="{{ route('get.contract', $contract->id) }}" target="_blank"
                class="btn btn-sm btn-primary btn-iconn m-2" title="{{ __('Preview') }}" data-bs-toggle="tooltip"
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mt-3">
                                            <textarea class="tox-target pc-tinymce-2" name="contract_description" id="summernote" rows="3">{!! $contract->contract_description !!}</textarea>
                                        </div>
                                    </div>
                                    @can('Create Contract')
                                        @if (\Auth::user()->type == 'company')
                                                        ...
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col-auto actions">
                                                                @can('Delete Attachment')
                                                                    @if (\Auth::user()->id == $file->user_id || \Auth::user()->type == 'company')
                                                        ...
                                                        @foreach ($contract->comment as $comment)
                                                            ...
                                                            <div class="list-group-item ">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    @can('Delete Comment')
                                                                        @if (\Auth::user()->id == $comment->user_id || \Auth::user()->type == 'company')
                                                        ...
                                                        @foreach ($contract->note as $note)
                                                            ...
                                                            <div class="list-group-item ">
                                                                <div class="row align-items-center">
                                                                    ...
                                                                    @can('Delete Note')
                                                                        @if (\Auth::user()->id == $note->user_id || \Auth::user()->type == 'company')
                                                                            <div class="p-0 w-auto action-btn bg-danger">
